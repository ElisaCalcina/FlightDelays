...
public class ExtFlightDelaysDAO {
	...
	public int getAirlinesNumber(Airport a) {
		//dato un id di un aeroporto conta quante compagnie operano su di esso
		...
		try {
			...
			//uso if e non while perchè mi aspetto che ci sia solo un risultato, dato che sto contando
			if(rs.next()) {
				res=rs.getInt("tot");
			}
